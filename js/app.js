...
//   // Mobil page quick counters (optional ids)
...
//   // Dashboard mini counters (optional)
...
//   recent.forEach(t => {
//     const date = new Date(t.created_at);
//     const typeClass = t.transaction_type === 'Credit' ? 'text-danger' :
//       t.transaction_type === 'Debit' ? 'text-success' : 'text-warning';

//     html += `
//       <tr>
//         <td>${date.toLocaleTimeString('en-PK', { timeStyle: 'short' })}</td>
...
// // =============================
// // Actions (Queries SAME)
// // =============================
// async function addCustomer() {
//   const srNo = $('new-sr-no')?.value;
...
//     const modalEl = $('addCustomerModal');
...
//   } catch (e) {
//     console.error(e);
//     showToast(e?.code === '23505' ? 'SR No. already exists!' : 'Error adding customer', 'error');
//   }
// }
...
//   const el = $('newSaleModal');
//   if (!el) return showToast('Sale modal not found on this page', 'warning');
//   new bootstrap.Modal(el).show();
// }
// function openVasooliModal() {
//   const el = $('vasooliModal');
//   if (!el) return showToast('Vasooli modal not found on this page', 'warning');
//   new bootstrap.Modal(el).show();
// }
// function openExpenseModal() {
//   const el = $('expenseModal');
//   if (!el) return showToast('Expense modal not found on this page', 'warning');
//   new bootstrap.Modal(el).show();
// }
...
//   if (stored) window.config.FUEL_PRICES = JSON.parse(stored);
...
//   // Page-wise loading (NO missing element errors)
//   const page = document.body.getAttribute('data-page');

//   // Always safe to load these (DOM update guarded)
//   await loadTanks();
//   await loadCustomers();

//   if (page === 'index') {
//     await loadTransactions(); // for recent table
//   }
...
//   if (page === 'customers') {
//     // customers table already handled
//   }
...
//   if (page === 'reports') {
//     // minimal: set report-date if exists
